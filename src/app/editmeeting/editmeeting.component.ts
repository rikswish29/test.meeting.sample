...
export class EditmeetingComponent implements OnInit {
  ...
  constructor(public socketService:SocketService, public meetingService : MeetingService ,private route:ActivatedRoute, private router: Router, private toastr : ToastrService, public userService : UserService, public cookie : CookieService) { 
  ...
  public onlineUserList: any = () => {
    ...
    loadEditableMeetingData() : any{
      let data = {
        authToken : this.authToken,
        meetingId : this.meetingId,
      }
  
      this.meetingService.getMeetingByMeetingId(data).subscribe(
        data => {
    ...
    updateMeeting(): any {
      ...
      this.meetingService.updateMeeting(data).subscribe(
        data => {
          let error = data.error;
          let message = data.message;
          ...
          if (error) {
            ...
            let broadcastData = {
              ...
              broadcastMessage : `Meeting by id ${this.meetingId} has been update`,
